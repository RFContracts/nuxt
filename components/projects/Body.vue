<template>
  <div>
    <v-flex v-for="(item, index) in this.objects.content" :key="item.id" :class="index === 0 ? '' : 'mt-200'">
            ...
            <v-flex xs6 sm5 md4 class="d-inline-flex">
              <div>
                <v-flex class="item-desc-body mt-100 mb-100">
                  ...
                  <nuxt-link to="/" class="item-title text-black">
                    <span>
                      Projects
                    </span>
                  </nuxt-link>
                </v-flex>
                <v-card-text v-html="item.content.description" class="item-desc hidden-item-desc-off pr-0 pl-0"/>
              </div>
            </v-flex>
            <v-flex xs6 sm6 md6 offset-md2 offset-sm-1 class="d-inline-flex">
              <v-card-text class="item-desc pr-0 pl-0">
                <v-img
      ...
      <v-container v-else-if="index !== 0">
        ...
        <div>
          <v-flex xs12 sm12 md10 offset-md1 class="float-none">
...
<style scoped>
  ...
  .v-image-case {
    -webkit-box-shadow: -10px 11px 35px 0px rgba(0, 0, 0, 0.3);
    -moz-box-shadow: -10px 11px 35px 0px rgba(0, 0, 0, 0.3);
    box-shadow: -10px 11px 35px 0px rgba(0, 0, 0, 0.3);
    display: block;
    width: 100%;
  }
